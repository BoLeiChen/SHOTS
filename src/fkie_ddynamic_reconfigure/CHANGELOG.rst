^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package fkie_ddynamic_reconfigure
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Merge branch 'fix-double-comparison' into 'erbium-devel'
  ...
  See merge request control/fkie_ddynamic_reconfigure!14
* Fix double comparison
...
* Merge branch 'refactor-functions' into 'erbium-devel'
  ...
  See merge request control/fkie_ddynamic_reconfigure!12
* Extend readme
...
* Merge branch 'fix-gmock-dependency' into 'erbium-devel'
  ...
  See merge request control/fkie_ddynamic_reconfigure!11
* Rename gmock dependency for public release
* Contributors: Victor Lopez
...
* Merge branch 'ddr_debug_msg' into 'erbium-devel'
  ...
  See merge request control/fkie_ddynamic_reconfigure!10
* changed info msg to debug
...
* Merge branch 'fix-test' into 'erbium-devel'
  Fix test
  See merge request control/fkie_ddynamic_reconfigure!9
...
* Merge branch 'fix-spammy' into 'erbium-devel'
  ...
  See merge request control/fkie_ddynamic_reconfigure!8
* Only publish when variables has changed
* Contributors: Hilario Tome, Victor Lopez
...
* Merge branch 'add-auto-publish' into 'erbium-devel'
  Add auto publish of updates values to fkie_ddynamic_reconfigure
  See merge request control/fkie_ddynamic_reconfigure!7
* Add auto publish of updates values to fkie_ddynamic_reconfigure
* Contributors: Hilario Tome, Victor Lopez
...
* Merge branch 'fix-test-crash' into 'erbium-devel'
  Fix test crash
  See merge request control/fkie_ddynamic_reconfigure!6
...
* Merge branch 'dubnium-devel' of gitlab:control/fkie_ddynamic_reconfigure into dubnium-devel
* Formating
* Add new file
...
* Prepare fkie_ddynamic_reconfigure for standalone package
* Added safe header
* Added test folder
