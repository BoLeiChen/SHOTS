...
double vehicleLength = 0.98;
double vehicleWidth = 0.66;
double sensorOffsetX = 0.068;
double sensorOffsetY = 0.06;
...
double pathScale = 1.3;
double minPathScale = 0.9;
double pathScaleStep = 0.4;
...
void odometryHandler(const nav_msgs::Odometry::ConstPtr& odom)
{
  ...
  vehicleZ = odom->pose.pose.position.z+0.2;
}
